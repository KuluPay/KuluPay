...
export default defineConfig({
  ...
  format: ['cjs', 'esm'],
  dts: true,
  external: ['react', 'react-dom', 'vue', '@stripe/stripe-js', '@kulupay/core', 'viem', 'tronweb', 'zod', '@reown/appkit', '@reown/appkit/react', '@reown/appkit-adapter-wagmi', '@reown/appkit-adapter-tron', '@tronweb3/tronwallet-adapter-tronlink', 'wagmi', '@wagmi/core', '@tanstack/react-query', '@better-fetch/fetch'],
  splitting: false,
  sourcemap: true,
  clean: true,
});
