...
- `lib/db.ts` — your database instance
...
KuluPay is database-agnostic. Create your own database instance and pass it via an adapter.
...
### Pre-configured Chains and Tokens

```typescript
import { CHAINS, TOKENS } from "@kulupay/onchain";

// Chain presets
CHAINS.ethereum; // { family: "evm", chainId: 1, name: "ethereum", ... }
